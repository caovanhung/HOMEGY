...
const uint8_t kTolerance = 40;   // default percent tolerance in measurements.
const uint8_t kUseDefTol = 255;  // Indicate to use the class default tolerance.
const uint16_t kRawTick = 10;     // Capture tick to uSec factor.
